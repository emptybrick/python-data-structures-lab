...
def manage_students():
    '''Not enough information for what this exercise wanted to return'''
    students = ["John", "James", "Jonah"]
    first_student = students[1]
    last_student = students[-1]
    return first_student, last_student, students
...
def slice_foods():
    '''Function that takes a tuple and creates a new list with the last 2 items in its index'''
    foods = ("Meat", "Vegetables", "Grains")
...
def hometown_info():
    '''Function that formats a dictionary into a string statement with its information'''
    home_town = {
        'city': 'City',
        'state': 'State',
        'Population': 1
...
def list_home_town_items():
    '''Function that iterates over a dictionary and outputs its key and value pairs in a new list as key = value'''
    home_town_items = []
    home_town = {
        'city': 'City',
        'state': 'State',
...
def create_awesome_students():
    '''Function that takes a list of student names and creates a new list with the name + is perfect'''
    students = ["John", "James", "Jonah"]
    awesome_students = list()
    for student in students:
        awesome_students.append(f"{student} is perfect!")
...
def filter_foods_with_a():
    '''Function that filters foods that contain the letter a from a tuple into a new list'''
    foods = ("Meat", "Vegetables", "Grains", "Shouldnt Show")
    foods_with_an_a = list()
    for food in foods:
        if food.count("a") > 0:
